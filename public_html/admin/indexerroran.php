	...
	<html lang="fr">
		...
		<div id="corp">
			...
			<img Src="image/logo_carto.png" alt="cartographe"> <br>
				Votre identifiant ou votre mot de passe n'a pas été reconnus. Merci de les vérifier et de réessayer.
			</p> <br>
			
			<form id="authentication" name="authentication" action="authentifier.php" method="post">
